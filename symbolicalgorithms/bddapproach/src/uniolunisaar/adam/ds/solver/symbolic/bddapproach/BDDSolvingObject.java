 ...
 */
public abstract class BDDSolvingObject<W extends Condition<W>> extends SolvingObject<PetriGame, W, BDDSolvingObject<W>> {

    // saves places divided into groups for each token
    private Set<Place>[] places;

    protected abstract void checkPrecondition(PetriGame game) throws NetNotSafeException, NotSupportedGameException;
