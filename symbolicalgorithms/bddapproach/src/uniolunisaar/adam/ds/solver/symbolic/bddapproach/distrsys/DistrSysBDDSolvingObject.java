package uniolunisaar.adam.ds.solver.symbolic.bddapproach.distrsys;
...
public class DistrSysBDDSolvingObject<W extends Condition<W>> extends BDDSolvingObject<W> {
    ...
    public DistrSysBDDSolvingObject(PetriGame game, W winCon) throws NotSupportedGameException, NetNotSafeException, NoSuitableDistributionFoundException, InvalidPartitionException {
        this(game, winCon, false);
    }

    public DistrSysBDDSolvingObject(PetriGame game, W winCon, boolean skipChecks) throws NotSupportedGameException, NoSuitableDistributionFoundException, InvalidPartitionException, NetNotSafeException {
    ...
    @Override
    protected void checkPrecondition(PetriGame game) throws NetNotSafeException, NotSupportedGameException {
