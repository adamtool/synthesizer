...
public class TestingAllFilesASafety {
    ...
    private static final List<String> withoutStrategy = new ArrayList<>(Arrays.asList(
            ...
            "nondet2.apt",// has a strategy for the journal version of ndet because nondet is overseen
            "nondet_jhh3.apt",// has a strategy for the journal version of ndet because nondet is overseen
            "nondet.apt",// has a strategy for the journal version of ndet because nondet is overseen
            "nondet2WithSys.apt" // has a strategy for the journal version of ndet because nondet is overseen
    // %%% Examples which we cannot solve when not checking it on the strategy
