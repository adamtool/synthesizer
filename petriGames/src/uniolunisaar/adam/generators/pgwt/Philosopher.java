...
public class Philosopher {
    ...
    public static PetriGameWithTransits generateGuided2(int n, boolean withPartition, boolean withMaxToken) {
        if (n < 2) {
...
//            envS.putExtension("MAXTOKEN", maxToken, ExtensionProperty.WRITE_TO_FILE);
    ...
    public static PetriGameWithTransits generateGuided(int n, boolean withPartition, boolean withMaxToken) {
        if (n < 2) {
            //todo: exception
            throw new RuntimeException("Error: need at least 2 philosophers");
        }
...
//            envS.putExtension("MAXTOKEN", maxToken, ExtensionProperty.WRITE_TO_FILE);
    ...
    public static PetriGameWithTransits generateIndividual(int n, boolean withPartition, boolean withMaxToken) {
        if (n < 2) {
            //todo: exception
            throw new RuntimeException("Error: need at least 2 philosophers");
        }
    ...
    private static void generateOne(PetriGameWithTransits pn, boolean env, int count, int max, boolean withPartition, boolean guided) {
