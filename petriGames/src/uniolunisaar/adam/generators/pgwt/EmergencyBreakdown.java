...
public class EmergencyBreakdown {
     ...
     * @return
     */
    public static PetriGameWithTransits createSafetyVersion(int nb_critical_machines, int nb_noncritical_machines, boolean withPartitioning) {
...
//        }
    ...
    private static void createMachine(PetriGameWithTransits net, Place ecom1, Place ecom2, int id) {
