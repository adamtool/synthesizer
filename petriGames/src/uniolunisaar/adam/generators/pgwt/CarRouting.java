...
public class CarRouting {
     ...
     * @return
     */
    public static PetriGameWithTransits createEReachabilityVersion(int nb_routes, int nb_cars, boolean withPartitioning) {
        if (nb_routes < 2 || nb_cars < 1) {
            throw new RuntimeException("less than 2 routes or 1 car is not an interesting example");
        }
        PetriGameWithTransits net = createGeneralNet(nb_routes, nb_cars, withPartitioning);
     ...
     * @return
     */
    public static PetriGameWithTransits createAReachabilityVersion(int nb_routes, int nb_cars, boolean withPartitioning) {
        if (nb_routes < 2 || nb_cars < 1) {
            throw new RuntimeException("less than 2 routes or 1 car is not an interesting example");
        }
        PetriGameWithTransits net = createGeneralNet(nb_routes, nb_cars, withPartitioning);
     ...
     * @return
     */
    public static PetriGameWithTransits createAReachabilityVersionWithRerouting(int nb_routes, int nb_cars, boolean withPartitioning) {
        if (nb_routes < 2 || nb_cars < 1) {
            throw new RuntimeException("less than 2 routes or 1 car is not an interesting example");
        }
        PetriGameWithTransits net = createGeneralNet(nb_routes, nb_cars, withPartitioning);
    ...
    private static PetriGameWithTransits createGeneralNet(int nb_routes, int nb_cars, boolean withPartitioning) {
        PetriGameWithTransits net = PGTools.createPetriGame("Car routing with " + nb_routes + " intruding " + nb_cars + " points");
        // Environment
