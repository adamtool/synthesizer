...
public class Clerks {
     ...
     * @return
     */
    public static PetriGameWithTransits generateNonCP(int size, boolean withPartition, boolean withMaxToken) {
        if (size < 1) {
...
//            net.setPartition(goodReady, 1);
    ...
    private static void createOneClerkNonCP(PetriGameWithTransits net, Transition t, int count, boolean withPartition) {
     ...
     * @return
     */
    public static PetriGameWithTransits generateCP(int size, boolean withPartition, boolean withMaxToken) {
        if (size < 1) {
            throw new RuntimeException("There should be at least one Clerk to sign the document.");
        }
        if (withMaxToken) {
// todo : !!!!!!!!!
    ...
    private static void createOneClerkCP(PetriGameWithTransits net, Transition t, int count, int max, boolean withPartition) {
