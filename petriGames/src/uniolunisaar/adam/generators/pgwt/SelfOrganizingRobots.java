...
public class SelfOrganizingRobots {
     ...
     * @return
     */
    public static PetriGameWithTransits generateImproved(int robots, int tools, int phases, boolean withPartition, boolean withMaxToken) {
        if (robots < 1) {
    ...
    private static PetriGameWithTransits addPhaseImproved(PetriGameWithTransits net, int robots, int tools, int id, boolean withPartition, boolean withMaxToken) {
     ...
     * @return
     */
    public static PetriGameWithTransits generate(int robots, int tools, int phases, boolean withPartition, boolean withMaxToken) {
        if (robots < 1) {
            throw new RuntimeException("less than 1 robots does not make any sense!");
        }
        if (tools < 1) {
    ...
    private static PetriGameWithTransits addPhase(PetriGameWithTransits net, int robots, int tools, int id, boolean withPartition, boolean withMaxToken) {
    ...
    private static PetriGameWithTransits addRobot(PetriGameWithTransits net, int id, int tools, boolean withPartition, boolean withMaxToken) {
     ...
     * @return
     */
    public static PetriGameWithTransits generate(int size, int destroy, boolean withPartition, boolean withMaxToken) {
        if (size < 2) {
...
//            env.putExtension("MAXTOKEN", maxtoken, ExtensionProperty.WRITE_TO_FILE);
    ...
    private static void createRobot(PetriGameWithTransits net, int rid, int size, int destroy, boolean withPartition) {
        for (int i = 0; i < size; ++i) {
            Place tool = null;
            if (destroy == 0) {
