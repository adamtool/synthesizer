...
public class ContainerTerminal {
     ...
     * @return
     */
    public static PetriGameWithTransits createSafetyVersion(int nb_containerPlaces, boolean withPartitioning) {
    ...
    private static void createContainerTerminal(PetriGameWithTransits net, int nb_containerPlaces, boolean withPartitioning) {
        // Environment
    ...
    private static void createContainer(PetriGameWithTransits net, boolean withPartitioning) {
    ...
    private static void createContainerPlaces(PetriGameWithTransits net, int nb_containerPlaces, boolean withPartitioning) {
    ...
    private static void createBattery(PetriGameWithTransits net, int robot_id, boolean withPartitioning) {
        // Environment
    ...
    private static void createCommunicationUnit(PetriGameWithTransits net, int robot_id, boolean withPartitioning) {
    ...
    private static void createTransportationOrChargingDecisionUnit(PetriGameWithTransits net, int robot_id, boolean withPartitioning) {
    ...
    private static void createTransportationUnit(PetriGameWithTransits net, int robot_id, int nb_containerPlaces, boolean withPartitioning) {
        Place status = net.getPlace("status" + robot_id);
        Place cont = net.getPlace("container");
    ...
    private static void createChargingUnit(PetriGameWithTransits net, int robot_id, boolean withPartitioning) {
        Place full = net.getPlace("full" + robot_id);
        Place medium = net.getPlace("medium" + robot_id);
        Place low = net.getPlace("low" + robot_id);
        Place status = net.getPlace("status" + robot_id);
    ...
    private static void createReset(PetriGameWithTransits net, int nb_containerPlaces, boolean withPartitioning) {
