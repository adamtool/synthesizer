...
public class Watchdog {
    ...
    public static PetriGameWithTransits generate(int nb_machines, boolean search, boolean partialObservation, boolean withPartition) {
        PetriGameWithTransits net = (!search) ? generateSmartSmokeDetector(nb_machines, partialObservation, withPartition)
                : generateSearching(nb_machines, partialObservation, withPartition);
        return net;
    }

    private static PetriGameWithTransits generateSmartSmokeDetector(int nb_machines, boolean partialObservation, boolean withPartition) {
        if (nb_machines < 1) {
...
//        }
     ...
     * machine.
     */
    private static PetriGameWithTransits generateSearching(int nb_machines, boolean partialObservation, boolean withPartition) {
        if (nb_machines < 1) {
            throw new RuntimeException("less than 1 machine does not make any sense!");
        }
...
//            }
     ...
     * machine.
     */
    private static PetriGameWithTransits generateWrongSearching(int nb_machines, boolean partialObservation, boolean withPartition) {
        if (nb_machines < 1) {
            throw new RuntimeException("less than 1 machine does not make any sense!");
        }
