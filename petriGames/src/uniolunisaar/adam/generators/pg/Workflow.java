...
public class Workflow {
    ...
    public static PetriGame generate2(int machines, int work_pieces, boolean withPartition) {
...
//        start.putExtension("MAXTOKEN", Integer.toString(maxtoken), ExtensionProperty.WRITE_TO_FILE);
    ...
    public static PetriGame generate(int machines, int work_pieces, boolean withPartition, boolean withMaxtoken) {
        if (machines < 2 || work_pieces < 1) {
            throw new RuntimeException("less than 2 machines or 1 work piece does not make any sense!");
        }
        PetriGame net = PGTools.createPetriGame("Workflow_" + "M" + machines + "WP" + work_pieces);
...
//        net.createFlow(t3, stop);
     ...
     * @return
     */
    public static PetriGame generateNewAnnotationPoster(int machines, int work_pieces, boolean withPartition, boolean withMaxtoken) {
        if (machines < 2 || work_pieces < 1) {
            throw new RuntimeException("less than 2 machines or 1 work piece does not make any sense!");
        }
        PetriGame net = PGTools.createPetriGame("Workflow_" + "M" + machines + "WP" + work_pieces);
...
//        net.createFlow(t3, stop);
     ...
     * @return
     */
    public static PetriGame generateImprovedVersion(int machines, int work_pieces, boolean withPartition, boolean withMaxtoken) {
        if (machines < 2 || work_pieces < 1) {
            throw new RuntimeException("less than 2 machines or 1 work piece does not make any sense!");
        }
...
//            net.createFlow(s, testT);
     ...
     * @return
     */
    public static PetriGame generateCP(int machines, int work_pieces, boolean withPartition, boolean withMaxtoken) {
        if (machines < 2 || work_pieces < 1) {
            throw new RuntimeException("less than 2 machines or 1 work piece does not make any sense!");
        }
        PetriGame net = PGTools.createPetriGame("Workflow_" + "M" + machines + "WP" + work_pieces);
