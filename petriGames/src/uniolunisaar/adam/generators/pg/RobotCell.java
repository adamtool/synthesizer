...
public class RobotCell {
    ...
    public static PetriGame generate(int size, int destroyable, boolean withPartition) {
        if (size < 2) {
            throw new RuntimeException("less than 2 robots and tools do not make any sense!");
        }
        PetriGame net = PGTools.createPetriGame("RobotCell_" + size);
    ...
    private static void createRobot(PetriGame net, int id, int size, int destroyable, boolean withPartition) {
