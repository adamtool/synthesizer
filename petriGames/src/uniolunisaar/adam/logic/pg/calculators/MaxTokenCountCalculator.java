...
import uniolunisaar.adam.util.pg.MaxiumNumberOfTokenCalculator;
...
public class MaxTokenCountCalculator extends ExtensionCalculator<Long> {
    ...
    @Override
    public Long calculate(PetriGame game) {
    ...
    public void setManuallyFixedTokencount(PetriGame game, long manuallyFixedTokencount) {
