...
import uniolunisaar.adam.exceptions.synthesis.pgwt.NotCoveredBySInvariants;
...
//            }
    ...
    private static Pair<Set<Place>, Set<Place>> getEnviromentInvariant(PetriGameWithTransits game, List<Set<Place>> invs) throws NoSuitableDistributionFoundException {
     ...
     *
     */
    private static List<Set<Place>> getMergedTokenFlowTrees(PetriGameWithTransits game, List<Set<Place>> invs, long tokencount) throws NoSuitableDistributionFoundException {
     ...
     */
    private static List<Set<Place>> getTokenFlowTrees(PetriGameWithTransits game, List<Set<Place>> invs) throws NoSuitableDistributionFoundException {
...
//            invs.remove(pairEnv.getFirst());
    ...
    private static List<Set<Place>> getFilledTokenFlowTrees(PetriGameWithTransits game, List<Set<Place>> invs, long tokencount) throws NoSuitableDistributionFoundException {
...
//        System.out.println(tokenFlowTrees.toString());
     ...
     * @throws NoSuitableDistributionFoundException
     */
    private static List<Set<Place>> getTokenFlowTrees2(PetriGameWithTransits game, List<Set<Place>> invs) throws NoSuitableDistributionFoundException {
        List<Set<Place>> ret = new ArrayList<>();
        Pair<Set<Place>, Set<Place>> pairEnv = getEnviromentInvariant(game, invs);
        if (pairEnv == null) { // no env places exists
            ret.add(new HashSet<>());
    ...
    private static boolean hasDistribution(PetriGameWithTransits game) throws NoSuitableDistributionFoundException {
